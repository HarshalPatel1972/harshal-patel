...
// ⚡ Bolt: Pre-compiled regex is faster than Array.some() + String.includes() on every request
...
export async function POST(req: NextRequest) {
    try {
        ...
        // ⚡ Bolt: Using regex test is more performant for high-frequency string matching
