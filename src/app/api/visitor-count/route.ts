...
// ⚡ Bolt Optimization: Use a pre-compiled RegExp instead of static array iteration
// to avoid O(n) overhead and new allocations on every high-frequency API hit.
