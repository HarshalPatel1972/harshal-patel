...
// ⚡ Bolt Optimization: Pre-compile a single regex instead of array iteration
// This avoids O(N) lookup and string allocation (.toLowerCase()) on every request.
...
export async function POST(req: NextRequest) {
    try {
        ...
        // 1. FILTER BOTS: Use pre-compiled regex for O(1) matching vs O(N) array iteration
