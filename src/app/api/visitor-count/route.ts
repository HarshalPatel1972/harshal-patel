...
// Pre-compile RegExp for faster bot detection, avoiding Array.some and toLowerCase inside the request handler
...
export async function POST(req: NextRequest) {
    try {
        ...
        // ⚡ Bolt: Using pre-compiled RegExp is measurably faster than Array.some with .toLowerCase()
