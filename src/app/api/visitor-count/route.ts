...
// Pre-compiled regex for faster bot detection on high-frequency route
...
export async function POST(req: NextRequest) {
    try {
        ...
        // Use pre-compiled RegExp instead of Array.some with string.toLowerCase for better performance
