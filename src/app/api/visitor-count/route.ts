...
export async function POST(req: NextRequest) {
    try {
        ...
        // Optimization: Use pre-compiled RegExp instead of Array.some + toLowerCase() to prevent
        // string allocations and improve throughput for this high-frequency route.
