...
// Pre-compiled RegExp for high-performance bot detection
// Eliminates iterative array lookups and redundant string lowercasing per request
...
export async function POST(req: NextRequest) {
    try {
        ...
        // 1. FILTER BOTS: High-performance regex check
        // Avoids full string allocations from .toLowerCase() and Array iteration
