...
type Language = "en" | "ja" | "ko" | "zh-tw" | "hi" | "fr" | "id" | "de" | "it" | "pt-br" | "es-419";
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (saved === "ja" || saved === "en" || saved === "ko" || saved === "zh-tw" || saved === "hi" || saved === "fr" || saved === "id" || saved === "de" || saved === "it" || saved === "pt-br" || saved === "es-419") {
