...
export function Navbar() {
  ...
  return (
    ...
    >
      <nav className="w-full max-w-7xl px-4 md:px-6 py-4 flex flex-col md:flex-row items-center justify-between pointer-events-auto gap-4 md:gap-0">
        
        <div className="text-white font-bold tracking-tight text-lg w-full md:w-auto text-center md:text-left">
