...
export function Navbar() {
  ...
  return (
    <>
      <nav className="fixed right-0 top-0 bottom-0 z-50 w-12 md:w-16 bg-[#E8E8E6]/80 backdrop-blur-md border-l border-[var(--bg-ink)]/10 flex flex-col justify-between items-center py-4 md:py-8 overflow-hidden">
