...
export function DesignVersionSwitcher() {
  ...
  return (
    <div className="fixed bottom-[115px] md:bottom-[335px] right-[64px] md:right-[97px] w-[4.5rem] md:w-[16rem] z-[99999] pointer-events-auto flex flex-col items-center gap-2.5 select-none">
      ...
      <div className="relative group inline-block">
        ...
        <button
          ...
          className="relative z-10 flex items-center gap-3.5 px-4 py-2.5 border text-xs font-mono tracking-wider uppercase transition-all duration-200 cursor-pointer group-hover:translate-x-[-1px] group-hover:translate-y-[-1px] group-active:translate-x-[1px] group-active:translate-y-[1px] whitespace-nowrap"
          style={{
