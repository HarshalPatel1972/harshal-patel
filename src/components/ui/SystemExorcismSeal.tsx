...
const SystemExorcismSeal: React.FC = () => {
  return (
    <div className="absolute inset-0 flex items-center justify-center z-0 pointer-events-none opacity-20 overflow-hidden">
      <svg 
        viewBox="0 0 1000 1000" 
        className="w-[150%] h-[150%] md:w-[100%] md:h-[100%] animate-pulse-slow"
        style={{ filter: 'drop-shadow(0 0 20px rgba(217,17,17,0.2))' }}
      >
        <defs>
        ...
        <g className="origin-center animate-[spin_60s_linear_infinite]">
          ...
          <circle cx="500" cy="500" r="420" fill="none" stroke="var(--accent-blood)" strokeWidth="0.5" strokeDasharray="1,15" />
          <circle cx="500" cy="500" r="410" fill="none" stroke="var(--accent-blood)" strokeWidth="2" strokeDasharray="100,50" />
          
          {/* Binary/Hex Bits orbiting the seal */}
          <g className="font-mono text-[8px] fill-[var(--accent-blood)] opacity-60">
        ...
        <g className="origin-center animate-[spin_40s_linear_infinite_reverse]">
          <circle cx="500" cy="500" r="280" fill="none" stroke="var(--accent-blood)" strokeWidth="1" />
          <path 
          ...
          <g opacity="0.3">
            {Array.from({ length: 10 }).map((_, i) => (
              <line 
                ...
                stroke="var(--accent-blood)" strokeWidth="0.5" 
              />
            ))}
            {Array.from({ length: 10 }).map((_, i) => (
              <line 
        ...
        <g stroke="var(--accent-blood)" strokeWidth="2" fill="none">
          <circle cx="500" cy="500" r="40" strokeWidth="4" />
