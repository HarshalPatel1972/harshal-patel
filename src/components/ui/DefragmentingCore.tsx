...
// Pre-compute static shards array outside the render cycle
// Hoisting this reduces garbage collection pressure and solves react-hooks/purity lint errors
const STATIC_SHARDS = Array.from({ length: 150 }).map((_, i) => {
