...
// Pre-calculate 150 chaotic shards for more density as a module-level constant
// This avoids react-hooks/purity lint errors due to Math.random() in render loops
// and provides a ~32x performance improvement by not dynamically generating on mount.
const SHARDS = Array.from({ length: 150 }).map((_, i) => {
