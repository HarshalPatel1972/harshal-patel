...
export function ScrollLine({ isVisible = true }: { isVisible?: boolean }) {
  ...
  return (
    <div className={`fixed bottom-4 right-[49px] md:bottom-8 md:right-[97px] z-[50] pointer-events-none mix-blend-difference text-white flex flex-col items-end leading-none select-none transition-opacity duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
       <div className="relative flex flex-col items-end">
         {/* Reclining Character (MAPPA 4th-Wall Break on the UI) */}
         <img 
           src="/Lying Down.png" 
           alt="Resting on the scroll" 
           className="w-[208px] md:w-[606px] -mb-[8px] md:-mb-[32px] mr-[5px] md:mr-[20px] translate-x-[22px] translate-y-[51px] md:translate-x-[87px] md:translate-y-[111px] z-20 pointer-events-none select-none"
         />
         {/* The 000 Text Block */}
         <div ref={textRef} 
              className="relative z-10 font-victor font-black text-[3.4rem] md:text-[11.8rem] tracking-tighter leading-[0.8] flex items-end w-[6rem] md:w-[24.5rem] justify-end"
