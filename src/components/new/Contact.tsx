      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative w-full max-w-7xl mt-12 mb-10 border-t border-b border-[var(--sumi-ink)]/10 flex flex-col md:flex-row flex-nowrap">
          {links.map((link, i) => {
            ...
            const cellContent = (
              <span className="relative z-10 flex flex-col md:flex-row md:items-center gap-4 md:gap-8 text-[4.5rem] sm:text-[6.5rem] md:text-[5rem] lg:text-[7rem] font-black font-display uppercase tracking-tighter text-[var(--sumi-ink)] transition-all duration-500 ease-[cubic-bezier(0.2,0.9,0.3,1)] md:group-hover:text-[var(--forge-orange)] pointer-events-auto leading-[0.9] text-left break-words overflow-visible">
