          ...
          {links.map((link, i) => {
            ...
            const cellContent = (
              <>
                ...
                <span className="relative z-10 text-[3rem] sm:text-[5rem] md:text-[6.5rem] lg:text-[8rem] font-black font-display uppercase tracking-tighter text-[var(--sumi-ink)] transition-all duration-500 ease-[cubic-bezier(0.2,0.9,0.3,1)] md:group-hover:text-[var(--forge-orange)] md:group-hover:-translate-y-2 pointer-events-auto leading-none">
