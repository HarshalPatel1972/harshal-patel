                    ...
                    >
                      <span 
                        className={`text-[2.2rem] md:text-[5rem] lg:text-[7rem] select-none transition-all duration-700
                          ${isSpecial ? 
                            `${language === 'hi' ? 'font-victor' : 'font-cirka'} text-[var(--accent-blood)] drop-shadow-[0_0_10px_rgba(217,17,17,0.3)]` : 
                            `${language === 'hi' ? 'font-victor' : 'font-victor'} text-[var(--text-bone)]`}`}
                      >
                        {word}
                      </span>
                    {/* Poetic Line breaks */}
