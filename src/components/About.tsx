...
export function About() {
  ...
  return (
    <section id="about" className="relative py-32 px-6 section-fade">
      {/* Background accent */}
      <div
        className="gradient-blob w-[500px] h-[500px] top-[30%] right-[-10%]"
        style={{
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <ScrollReveal>
          <span className="text-sm font-mono text-teal-400 tracking-widest uppercase mb-4 block">
            About Me
          </span>
          <h2 className="text-4xl md:text-6xl font-bold tracking-tight mb-16" style={{ fontFamily: "var(--font-display)" }}>
            Who I
            <span className="bg-gradient-to-r from-teal-400 to-emerald-400 bg-clip-text text-transparent"> Am</span>
          </h2>
        </ScrollReveal>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-10">
            ...
            <ScrollReveal delay={200}>
              <h3 className="text-sm font-mono text-emerald-400 tracking-widest uppercase mb-6">
                Experience
              </h3>
              <div className="space-y-6">
                {profile.experience.map((job) => (
                  <div
                    key={job.company}
                    className="glass-card p-5 group hover:border-white/15 transition-colors"
                  >
          ...
          <div className="space-y-10">
            ...
            <ScrollReveal delay={150} direction="right">
              <div className="glass-card p-6">
                <h3 className="text-sm font-mono text-violet-400 tracking-widest uppercase mb-4">
                  Education
                </h3>
            ...
            <ScrollReveal delay={250} direction="right">
              <div ref={skillsRef}>
                <h3 className="text-sm font-mono text-rose-400 tracking-widest uppercase mb-6">
                  Technical Skills
                </h3>
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  <div key={stat.label} className="glass-card p-4 text-center">
                    ...
                    <div className="text-[11px] font-mono text-white/30 mt-1 uppercase">
                      {stat.label}
                    </div>
                  </div>
                ))}
