...
## 2026-08-16 - Avoid Memoizing Minor String Splits\n**Learning:** Memoizing string splits (like `.split(" ")`) on extremely short, static strings inside render loops is a micro-optimization with zero measurable performance impact. It violates performance constraints against premature optimization.\n**Action:** Avoid applying `useMemo` to trivial string operations; prioritize actual performance bottlenecks like layout thrashing, unoptimized network requests, or massive state-driven re-renders.
